...
def home():
    qa = [
        ...
        {"question": "What is a service account in Active Directory, and how is it used?", "answer": "A service account is a special type of account used to run services, tasks, or processes. It has permissions tailored to the needs of the service, minimizing security risks."},
        {"question": "Can you explain the process of backing up and restoring Active Directory?", "answer": "To back up Active Directory, use the Windows Server Backup feature to create a system state backup. To restore, boot into Directory Services Restore Mode (DSRM) and use the backup to restore the system state."},
        {"question": "What is your experience with virtualization technologies in a Microsoft environment?", "answer": "I have experience with Hyper-V, managing virtual machines, creating and managing virtual networks, and integrating with System Center Virtual Machine Manager (SCVMM)."},
        {"question": "What is your experience with Windows Server Update Services (WSUS)?", "answer": "I have experience in configuring and managing WSUS for deploying updates across the network, creating update policies, and troubleshooting update issues."},
        ...
        {"question": "A critical server is running low on disk space. What steps would you take to free up space on the server and prevent this issue from recurring?", "answer": "I would identify and delete unnecessary files, such as old logs and temporary files, move large files to another storage, and consider expanding the storage capacity. I would also set up monitoring to prevent future issues."},
        {"question": "A new application needs to be installed on multiple Windows computers in the network. What approach would you take to ensure a successful and efficient deployment of the application?", "answer": "I would use Group Policy or a deployment tool like System Center Configuration Manager (SCCM) to automate the installation process, ensuring consistency and reducing manual effort."},
        {"question": "A user complains that they are unable to connect to a VPN. What steps would you take to troubleshoot and resolve the issue?", "answer": "I would verify the user's credentials, check the VPN server's status, ensure that the user's device is correctly configured, and check for any network issues that might be blocking the connection."},
        {"question": "A database on a server has become corrupted, causing data loss. What steps would you take to recover the lost data and prevent similar incidents in the future?", "answer": "I would restore the database from the most recent backup, check for and fix any underlying issues that caused the corruption, and ensure that regular backups are being taken."},
        {"question": "A server’s RAID array has failed, causing data loss. What steps would you take to recover the lost data and ensure that the server is back online as soon as possible?", "answer": "I would replace the failed disk(s), rebuild the RAID array, restore data from backups if necessary, and review the RAID setup to ensure redundancy and reliability."},
        {"question": "An employee has left the company, and their account needs to be disabled across all systems. What steps would you take to ensure their access is revoked and data secured?", "answer": "I would immediately disable their user account, revoke any access tokens or credentials, and review logs for any unusual activity. I would also ensure that data is secured and reassign any critical tasks."},
